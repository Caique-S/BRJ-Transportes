...
export default function DashboardProgressBar({ 
  ...
  const determinarTurno = () => {
    ...
    return horaAtual >= 6 && horaAtual < 18 ? "SBA02" : "SBA04";
  };
    ...
    try {
      ...
      if (response.ok) {
        ...
        setUltimaAtualizacao(
          new Date(data.ultimaAtualizacao || new Date()).toLocaleTimeString('pt-BR', {
            hour: '2-digit',
            minute: '2-digit'
          })
        );
        ...
        {showDetails && (
          <div className="mt-6 w-full space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold">{totalVeiculosPrevistos} veículos</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Concluídos:</span>
              <span className="font-semibold text-green-600">{veiculosConcluidos} veículos</span>
            </div>
            <div className="flex justify-between items-center">
